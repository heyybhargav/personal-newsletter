            ...
            <section className="py-24 px-6 text-center border-t border-gray-100">
                <div className="max-w-xl mx-auto space-y-8">
                    ...
                    <div className="pt-8 space-y-4">
                        <button
                            onClick={triggerLogin}
                            className="group relative inline-flex items-center justify-center gap-3 px-10 py-5 text-lg font-medium text-white bg-[#111111] rounded-full hover:scale-105 transition-all duration-300 shadow-xl shadow-black/5 overflow-hidden"
                        >
                            {/* Shimmer Effect */}
